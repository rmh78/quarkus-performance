...
sleep 1
/work/scripts/test-single.sh "/work/demo-quarkus/target/demo-ee -Xmn8M -Xmx8M" $DEMO_URL quarkus-native-simple-ee "Quarkus (JAX-RS) via GraalVM Native Image (19.3.2 EE)"
sleep 1
...
sleep 1
/work/scripts/test-single.sh "/work/demo-quarkus-jpa/target/demo-ee -Xmn8M -Xmx8M" $DEMO_URL quarkus-native-advanced-ee "Quarkus (JAX-RS + JPA) via GraalVM Native Image (19.3.2 EE)"